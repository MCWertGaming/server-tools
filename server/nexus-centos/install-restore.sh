...
# remove data directory ecause it gets rstored
rm -rf sonatype-work/
## restore old config
# mount nfs volume
mount 10.10.11.5:/mnt/nfs_share/nexus-backup /mnt
# go into nexus directory
cd /opt/nexus3/
# copy backup
cp /mnt/nexus-backup.tar.zst nexus-backup.tar.zst
# extract backup
